...
{
    const QString taskKey = m_model.runtimeTaskKeyForDesktopFileName(desktopFileName);
    return taskKey.isEmpty() ? QVector<Astrea::Typhon::Toplevel>{}
                             : windowsForTaskKey(taskKey);
}

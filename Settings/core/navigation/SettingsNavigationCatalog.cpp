...
SettingsNavigationCatalog::SettingsNavigationCatalog()
    : m_entries{
          ...
          makeEntry(QStringLiteral("appearance"), QStringLiteral("Appearance"),
                    QStringLiteral("settings.nav.appearance"), QStringLiteral("Light, dark, and interface style"),
                    {}, QStringLiteral("theme"),
          ...
          makeEntry(QStringLiteral("themes"), QStringLiteral("Themes"),
                    QStringLiteral("settings.nav.themes"), QStringLiteral("Installed icon themes"),
                    {}, QStringLiteral("theme"),
                    QUrl(QStringLiteral("qrc:/qt/qml/Astrea/Settings/qml/pages/appearance/Themes.qml")),
                    SettingsNavigationEntry::Kind::Page, true, false, QStringLiteral("customization")),

...
Rectangle {
    ...
    property int minWidth: 44
    property int horizontalPadding: Components.Theme.spacingLarge
    ...
    color: {
        ...
        return pressed ? Qt.rgba(1, 1, 1, 0.13) : (hovered ? Qt.rgba(1, 1, 1, 0.10) : Components.Theme.cardBg)
    }
    border.width: 1

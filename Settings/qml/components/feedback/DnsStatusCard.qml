...
Rectangle {
    ...
    property string providerLabel: I18n.tr("core.components.feedback.dns_status_card.provider.automatic_isp", "Automatic (ISP)")
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: root.isAuto
                        ? I18n.tr("core.components.feedback.dns_status_card.status.auto", "Auto")
                        : I18n.tr("core.components.feedback.dns_status_card.status.manual", "Manual")
                    color: root.badgeColor
                    font.family: Components.Theme.fontFamily

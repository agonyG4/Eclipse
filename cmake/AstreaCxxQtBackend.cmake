...
function(astrea_add_cxx_qt_crate)
    ...
    if(args_CXXQT_HEADERS)
        ...
        set(_astrea_cargo_build_target "cargo-build_${args_CRATE_NAME}")
        if(TARGET ${_astrea_cargo_build_target})
            add_dependencies(${args_CRATE_NAME}_cxxqt_headers ${_astrea_cargo_build_target})
        endif()
    endif()
endfunction()
